...
struct SuggestionsMenuItem
{
  ...
  SuggestionsMenuItem (wchar_t *TextArg, BYTE IdArg, MenuFlagEnum::e FlagArg = MenuFlagEnum::SIMPLE_ITEM)
  {
    Text = 0;
...
void InsertSuggMenuItem (HMENU Menu, wchar_t *Text, BYTE Id, int InsertPos, HMENU &HMenuTempStore, MenuFlagEnum::e Flag = MenuFlagEnum::SIMPLE_ITEM);
...
private:
  ...
  long LastCurPos;
  std::vector<wchar_t *> *MultiLangList;
